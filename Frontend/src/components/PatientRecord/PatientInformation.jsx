      ...
      <div className="flex justify-center items-center h-32 w-full">
        <div className="text-center">
          ...
          <button
            ...
            className="px-4 py-1 text-xs bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors cursor-pointer"
          >
            Retry
          </button>
        </div>
  ...
  const getPatientPhoneNumber = () => {
   ...
   const getPatientAddress = () => {
    return patientData.address ||
           patientData.primaryAddress ||
           patientData.contactAddress ||
           patientData.residentialAddress ||
           patientInfo.address ||
           patientInfo.primaryAddress ||
           patientInfo.contactAddress ||
           patientInfo.residentialAddress ||
           '-';
  };
    ...
    try {
      ...
      if (!hospitalId || !patientId) {
        ...
        setPatientData({
          ...
          phone: patientInfo.phone || patientInfo.primaryNumber || patientInfo.contactNumber || '-',
          age: patientInfo.age || '-',
        ...
        if (apiPatientData) {
          setPatientData({
            ...
            phone: apiPatientData.phone || 
                   ...
                   patientInfo.contactNumber ||
                   '-',
            age: apiPatientData.age || patientInfo.age || '-',
            gender: apiPatientData.gender || patientInfo.gender || '-',
      ...
      {error && (
        <div className="fixed bottom-6 right-6 bg-red-50 border border-red-200 text-red-700 p-4 rounded-lg shadow-lg max-w-sm no-print">
          ...
          <button
            ...
            className="w-full mt-2 px-4 py-2 bg-red-600 text-white text-sm rounded hover:bg-red-700 transition-colors cursor-pointer"
          >
            Regenerate Document
          </button>
        </div>
